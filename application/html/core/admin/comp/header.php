                ...
                <div class="navbar-collapse" id="navbar-mobile">
                    ...
                    <ul class="nav navbar-nav float-right">
                        ...
                        <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="javascript:void(0);" data-toggle="dropdown">
                                <div class="user-nav d-sm-flex d-none"><span class="user-name"><?php echo $currentUser['FNAME']." ".$currentUser['LNAME']; ?></span><span class="badge badge-success round user-status text-white"><?php echo $role;?></span></div><span>
                                    <?php 
                                    if(($currentUser['PHOTO'] != '') && ($currentUser['PHOTO'] != null)){
                                        if (@getimagesize($currentUser['PHOTO'])) {
                                            ?>
                                            <img class="round" src="<?php echo $currentUser['PHOTO']; ?>" alt="avatar" height="40" width="40">
                                            <?php
                                        }else{
                                            ?>
