...
<head>
    ...
    <title>DOE API Credential</title>
            ...
            <div class="content-header row">
                <div class="content-header-left col-12 mb-2 mt-1">
                    <div class="breadcrumbs-top">
                        <h5 class="content-header-title float-left pr-1 mb-0 text-white">DOE API </h5>
                        <div class="breadcrumb-wrapper d-none d-sm-block">
                            <ol class="breadcrumb p-0 mb-0 pl-1">
                                <li class="breadcrumb-item active"><a href="index.html"><i class="bx bx-home-alt"></i></a></li>
                                <li class="breadcrumb-item active"><a href="app-user-list">Credentials</a></li>
                            </ol>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-12 col-sm-5">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Create new credential</h4>
                            </div>
                            <div class="card-body">
